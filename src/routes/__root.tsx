...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Dog Mind Milano · Educatore cinofilo a Milano" },
      { name: "twitter:description", content: "Educatore cinofilo a Milano. Sessioni private a domicilio per cuccioli, cani giovani e gestione urbana. Metodo basato sulla relazione. Prima consulenza in 48h." },
